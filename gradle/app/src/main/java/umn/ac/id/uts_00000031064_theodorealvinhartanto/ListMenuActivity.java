...
public class ListMenuActivity extends AppCompatActivity implements
        RecycleSongTouchHelper.RecycleSongTouchHelperListener, SongAdapter.SongAdapterListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()==R.id.about){
            startActivity(new Intent(this, ProfileLoggedActivity.class));
    ...
    private void welcomeMessage(){
        dialog = new AlertDialog.Builder(ListMenuActivity.this);
    ...
    public boolean deleteMusic(final File file) {
        ...
        final ContentResolver contentResolver = ListMenuActivity.this.getContentResolver();
